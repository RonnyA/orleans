# HelloWorld.NetCore
Orleans Adventure sample converted to .NET Core
...
#### Running the sample
From Visual Studio, you can start start the Adventure.SiloHost and Adventure.Client projects simultaneously (you can set up multiple startup projects by right-clicking the solution in the Solution Explorer, and select `Set StartUp projects`.

Alternatively, you can run from the command line:

To start the silo
```
dotnet run --project src\Adventure.SiloHost
```
